module.exports = {
	...
	roleRemoved: "Роль {{role}} будет очищена",
	rolesRemoved: "Роли {{role}} будут очищены",
	roleAdded: "Роль {{role}} будет добавлена",
	rolesAdded: "Роли {{role}} будут добавлены",
	roleChanged: "Роль будет изменена на {{role}}",
	rolesChanged: "Роли будут изменены на {{role}}",
